...
class Evaluation(object):
    ...
    def val(self):
        ...
        with torch.no_grad():
                ...
                # for r in R:
                #     logger.info("{} --> Recall : {}".format(r, R[r]))
                # for p in P:
                #     logger.info("{} --> Persion : {}".format(p, P[p]))
                for i in APs:
    ...
    def detection(self):
        ...
        if self.__visiual:
            ...
            for v in imgs:
                ...
                bboxes_prd = self.__evalter.get_bbox(img, mode=self.__mode)
                ...
                if bboxes_prd.shape[0] != 0:
                    ...
                    logger.info("saved images : {}||FPS:{}".format(path,fps))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--visiual",
        type=str,
        default="data/VOCtest-2007/VOCdevkit/VOC2007/JPEGImages",
